...
\begin{frame}{Java}
  \begin{itemize}
  \item \item Lambdas
  \item Java's generics was designed by Philip Wadler himself!
  \item Pattern matching
  \end{itemize}
\end{frame}

\begin{frame}{React}
  React is based heavily on functional programming ideas like pure functions, immutability, avoiding mutation, and avoiding state!
\end{frame}
